...
namespace SpaceInvaderPlusPlus.Weapons
{
    ...
    {
        public TheSaw(Vector2 position, float angle = 0.0f, string spriteName = "thesaw", int entityLayer = 1) : base(position, angle, spriteName, entityLayer)
        {
            this.Cooldawn = 0.5f;
            this.Ammunition = 20;
            this.MaxAmmunition = 40;
            this.Damage = 2;
            this.ProjectileSpriteName = "thesaw_bullet";
            this.FireEffect = new Entity(this.Position, 0.0f, "thesaw_fire", 1);
